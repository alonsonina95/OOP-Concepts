...
public static <E extends Comparable<E>> ArrayList<E> removeDuplicates(ArrayList<E> listWithDuplicates) {
	...
	for(int i = 1; i < listWithDuplicates.size() ; i++) {
		for(int j =0 ; j < newList.size(); j++) {
			if(listWithDuplicates.get(i).compareTo(newList.get(j)) == 0) {
				found = true;
				break;
			}
		if (found != true) {
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNTk4OTAwNzUsLTE2MjEwNjQ0MCwxNj
M3NzUxOTAsLTEzNzM4NzQ0NTMsLTI0NjIyNTM0MiwtMTc5NTEx
MDQxLDE3NDk4NDUyMjEsLTMzMTg0MDExMiw5NjQxMjk2MDYsMT
c5OTk3NzM2MCwxOTQ4ODMwMDEyXX0=
-->